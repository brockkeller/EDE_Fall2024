...
#Reveal the column names
colnames(huc8_sf)
# can also do it by going glimpse(huc8_sf)

#Check the CRS
st_crs(huc8_sf)
#doing st_crs(huc8_sf)$epsg will also work
#go to epsg.io to look up the codes individually
#4326
...
ggplot() +
  ...
  geom_sf(data = un_sf, fill = 'yellow', color = 'red')
```
...
wind_df <- read.csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv', 
...
#have to reduce this to 8 digit HUCs because that's how our data in the other df are and they won't join otherwise
