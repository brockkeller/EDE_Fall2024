...
library(dplyr) #testing this out to see if it will let me select columns stored as factors. I think it was already installed.
...
NC_O3_2018$Date <- mdy(NC_O3_2018$Date) #setting it to the correct date format. #this is returning all as NAs. Need to see what is wrong with the code.
...
#4
NC_O3_2018_select <- select(NC_O3_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)

NC_O3_2019_select <- select(NC_O3_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)

NC_PM25_2018_select <- select(NC_PM25_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)

NC_PM25_2019_select <- select(NC_PM25_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
#this one finally fucking worked so keep this code here!
...
NCAir18_19 <- rbind(NC_O3_2018_select, NC_O3_2019_select, NC_PM25_2018_select, NC_PM25_2019_select) #combining my datasets
NCAir18_19
...
NCAir_shared_sites_spread <- pivot_wider(NCAir_shared_sites, names_from = AQS_PARAMETER_DESC, values_from = meanAQI)
