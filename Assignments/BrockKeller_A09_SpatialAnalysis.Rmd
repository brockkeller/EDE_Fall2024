...
> ANSWER:
> dec_lat_va represents the x coordinate and dec_long_va the y coordinate.
...
Nebraska_gauge_locations_sf <- st_as_sf(Nebraska_gauge_locations_df, coords = c('dec_lat_va', 'dec_long_va'), crs = 4326)
