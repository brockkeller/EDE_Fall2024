...
```{r}
str(Neonics) #gives the structure of the dataset. Tells me it is 4632 observations of 30 variables (30 columns by 4632 rows)
...
> Answer: Needes tend to have the highest biomass at the Niwot Ridge sites. 
