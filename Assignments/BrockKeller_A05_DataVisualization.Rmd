...
my_theme <- theme_linedraw() + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1), panel.grid.minor.y = element_line(size = 0), panel.grid.major.y = element_line(size = 0.08), panel.grid.major.x = element_line(linetype = "dotted", size = 0.25, color = "black"))
...
PPL_temp_month <-
  ...
  ggplot(aes(x = factor(month, levels = 1:12, labels = month.abb), y = temperature_C, color = lakename)) + #describing the aesthetics
...
Needle_mass_by_date <-
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1), plot.title = element_text(hjust = 0.5, face = "bold"))
