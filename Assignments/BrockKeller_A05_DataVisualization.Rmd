...
my_theme <- theme_tufte() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1), legend.position = "top", panel.grid.major = element_line(linetype = "dashed"))
...
print(PPL_phosphorous_phosphate)
...
PPL_temp_month <-
  ...
  scale_y_discrete(name = "Temperature (C)") #actually naming axis
...
plot_grid(PPL_temp_month, PPL_tp_month, PPL_tn_month)
